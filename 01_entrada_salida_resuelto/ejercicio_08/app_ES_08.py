...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        resultado_resto = valor_a_int % valor_b_int
        mensaje_resultado = "El resto de dividir {0} por {1} es {2}".format(valor_a_int, valor_b_int, resultado_resto)
        alert(title="ejercicio 8.1", message= mensaje_resultado)
