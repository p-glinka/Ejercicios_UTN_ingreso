...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        ...
        operador_a_int = int(operador_a_str)
        operador_b_int = int(operador_b_str)
        resultado_suma = operador_a_int + operador_b_int
        mensaje_resultado = "El resultado de la sumas es: {}".format(resultado_suma)
        alert("ejercicio 6.1", message= mensaje_resultado)
    ...
    def btn_restar_on_click(self):
        ...
        operador_b_int = int(operador_b_str)
        resultado_suma = operador_a_int - operador_b_int
        mensaje_resultado = "El resultado de la resta es: {}".format(resultado_suma)
        alert("ejercicio 6.1", message= mensaje_resultado)
    ...
    def btn_multiplicar_on_click(self):
        ...
        operador_b_int = int(operador_b_str)
        resultado_suma = operador_a_int * operador_b_int
        mensaje_resultado = "El resultado de la multiplicacion es: {}".format(resultado_suma)
        alert("ejercicio 6.1", message= mensaje_resultado)
    ...
    def btn_dividir_on_click(self):
        ...
        operador_b_int = int(operador_b_str)
        resultado_suma = operador_a_int / operador_b_int
        mensaje_resultado = "El resultado de la division  es: {}".format(resultado_suma)
        alert("ejercicio 6.1", message= mensaje_resultado)
