...
class App(customtkinter.CTk):
    ...
    def btn_informar_on_click(self):
        ...
        match (mes_elegido):
            case "Febrero":
                mensaje = f"Es {mes_elegido}; Este mes no tiene mas de 29 dias"
            case _:
                mensaje = f"Es {mes_elegido}; Este mes tiene 30 dias o mas "
                
        alert(title="ejercico 3.match", message= mensaje)
