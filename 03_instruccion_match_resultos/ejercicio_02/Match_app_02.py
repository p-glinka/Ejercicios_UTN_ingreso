...
class App(customtkinter.CTk):
    ...
    def btn_informar_on_click(self):
        ...
        match  (mes_seleccionado) :
            case "Julio" | "Agosto":
                mensaje = f"Es {mes_seleccionado}, Abrigate, estamos en Invierno "
            case "Marzo" | "Abril" | "Mayo" | "Junio":
                mensaje = f"Es {mes_seleccionado}, todavia falta para el invierno"
            case _: 
                mensaje = f"Es {mes_seleccionado}, ya pasamos el frio, ahora el calor"
                
        alert(title="ejercicio 2.match", message = mensaje)
