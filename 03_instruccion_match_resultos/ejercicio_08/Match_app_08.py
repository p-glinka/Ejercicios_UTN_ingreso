...
class App(customtkinter.CTk):
    ...
    def btn_informar_on_click(self):
        ...
        match (destino):
            case "Cataratas": 
                mensaje = f"En {destino} hace Calor en la mayoria del año"
            case _: 
                mensaje = f" En {destino}, hace Frio  en la mayoria del año"
        alert(title="ejercicio 8.Match", message= mensaje)
