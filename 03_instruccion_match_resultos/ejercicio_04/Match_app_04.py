...
class App(customtkinter.CTk):
    ...
    def btn_informar_on_click(self):
        ...
        match  (mes_seleccionado) :
            case  "Febrero" :
                mensaje = f"Es {mes_seleccionado}; El mes seleccionado tiene 28 o 29 dias segun si es bisiesto"
            case "Abril" | "Junio" | "Septiembre" | "Noviembre":
                mensaje = f"Es {mes_seleccionado}; El mes seleccionado tiene 30"
            case _:
                mensaje = f"Es {mes_seleccionado}; El mes seleccionado tiene 31 dias"

            
                
        alert(title="ejercicio 4.match", message = mensaje)
