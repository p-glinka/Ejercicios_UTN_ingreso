...
class App(customtkinter.CTk):
    ...
    def btn_informar_on_click(self):
        ...
        match (hora_ingresada):
            case "7" | "8" | "9" | "10" | "11" :
                mensaje = f"Son las {hora_ingresada}; es de Mañana"
            case "12" | "13" | "14" | "15" | "16" | "17" | "18" | "19":
                mensaje = f"Son las {hora_ingresada}; es de Tarde"
            case "20" | "21" | "22" | "23" | "24" | "00" | "1" | "2" |"3" | "4" | "5" | "6":
                mensaje = f"Son las {hora_ingresada}; es de Noche"
            case _:
                mensaje = f"El numero  {hora_ingresada}; no representa un horario"
        
        alert(title="ejercicio 6.match", message=mensaje)
