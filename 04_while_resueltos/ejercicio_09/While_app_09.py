...
class App(customtkinter.CTk):
    ...
    def btn_comenzar_ingreso_on_click(self):
        ...
        while (flag_continuar):
            numero_ingresado_str = prompt(title="numero ingresado", prompt="ingrese un numero")
            if(numero_ingresado_str == None):
                flag_continuar = False
                print("sali")
            else:
                numero_ingresado_int = int(numero_ingresado_str)
                if(numero_max == None or numero_ingresado_int > numero_max):
                    numero_max = numero_ingresado_int
                if(numero_min == None or numero_ingresado_int < numero_min ):
                    numero_min = numero_ingresado_int
