...
class App(customtkinter.CTk):
    ...
    def btn_calcular_on_click(self):
        ...
        largo_terreno_int = int(largo_terreno)
        ancho_terreno_int = int(ancho_terreno)
        metros_cuadrados = largo_terreno_int * ancho_terreno_int
        perimetro_del_terreno = (2 * largo_terreno_int) + ( 2 * ancho_terreno )
